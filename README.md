...
ruins_classifier
- All data for ruins_classifier is attached
...
# Open AI to Z Submission ## Eric Sullivan ## June 2025
...
Note: In these notebooks data is accessed in Kaggle through paths. If you would like to follow along you will need to set up your own paths.
